...
class CustomerProfile extends StatefulWidget {
  ...
  const CustomerProfile({super.key, required this.CustomerPhoneNumber});
...
Future<void> getData(String CustomerNID) async {
    ...
    Query query = _collectionRef.where("CustomerPhoneNumber", isEqualTo: CustomerNID);
...
Future<void> getSaleData() async {
  ...
  CollectionReference _collectionCustomerOrderHistoryRef =
    ...
    Query CustomerOrderHistoryQuery = _collectionCustomerOrderHistoryRef.where("CustomerPhoneNumber", isEqualTo: widget.CustomerPhoneNumber);
...
@override
  void initState() {
    ...
    getData(widget.CustomerPhoneNumber);
