...
class AllOldOrder extends StatefulWidget {
  const AllOldOrder({super.key});

  @override
  State<AllOldOrder> createState() => _AllOldOrderState();
}

class _AllOldOrderState extends State<AllOldOrder> {
...
Future<void> getData() async {
    ...
    Query CustomerOrderHistoryQuery = _collectionRef.where("DeliveryStatus", isEqualTo: "DeliveryComplete").where("OrderType", isEqualTo: "online");
