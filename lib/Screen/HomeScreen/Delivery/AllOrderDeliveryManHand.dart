...
class AllOrderDeliveryManHand extends StatefulWidget {
  const AllOrderDeliveryManHand({super.key});

  @override
  State<AllOrderDeliveryManHand> createState() => _AllOrderDeliveryManHandState();
}

class _AllOrderDeliveryManHandState extends State<AllOrderDeliveryManHand> {
...
Future<void> getData() async {
    ...
    Query CustomerOrderHistoryQuery = _collectionRef.where("DeliveryStatus", isEqualTo: "OnTheRoad");
