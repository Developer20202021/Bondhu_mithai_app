...
import 'package:bondhu_mithai_app/Screen/AllRegistrationScreen/CashReceiverImageUpload.dart';
...
class CashReceiverRegistration extends StatefulWidget {
  const CashReceiverRegistration({super.key});

  @override
  State<CashReceiverRegistration> createState() => _CashReceiverRegistrationState();
}

class _CashReceiverRegistrationState extends State<CashReceiverRegistration> {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
       ...
       automaticallyImplyLeading: false,
        title: const Text("Cash Receiver Registration", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
      ...
      body: SingleChildScrollView(
            ...
            SizedBox(
                  ...
                  // if (response.statusCode == 200) {
                    ...
                    // then parse the JSON.
                     final docUser =  FirebaseFirestore.instance.collection("CashReceiver");

                      final jsonData ={

                        "CashReceiverName":myAdminNameController.text.trim().toLowerCase(),
                        "CashReceiverEmail":myEmailController.text.trim().toLowerCase(),
                        "emailVerified":"",
                        "AdminApprove":"false",
                  ...
                  ScaffoldMessenger.of(context)
                   ...
                   Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CashReceiverImageUpload( CashReceiverEmail: myEmailController.text.trim().toLowerCase(),)),
                );
