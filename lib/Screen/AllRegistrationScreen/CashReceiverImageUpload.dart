...
class CashReceiverImageUpload extends StatefulWidget {



  final CashReceiverEmail;





  const CashReceiverImageUpload({super.key,  required this.CashReceiverEmail,});

  @override
  State<CashReceiverImageUpload> createState() => _CashReceiverImageUploadState();
}

class _CashReceiverImageUploadState extends State<CashReceiverImageUpload> {
...
Future NIDBackImageCamera(BuildContext context) async {
  ...
  Future updateData(String CashReceiverImageUrl,BuildContext context) async{
    ...
    setState(() {
      ...
      print("__________________________________________________________${widget.CashReceiverEmail}");


         final docUser = FirebaseFirestore.instance.collection("CashReceiver").doc(widget.CashReceiverEmail);

                  final UpadateData ={

                    "CashReceiverImageUrl":CashReceiverImageUrl
    ...
    Future updateNIDFrontImageData(String CashReceiverNIDFrontImageUrl,BuildContext context)
     ...
     async{
      ...
      setState(() {
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Admin").doc(widget.CashReceiverEmail);

                  final UpadateData ={

                    "CashReceiverNIDFrontImageUrl":CashReceiverNIDFrontImageUrl
    ...
    Future updateNIDBackImageData(String CashReceiverNIDBackImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Admin").doc(widget.CashReceiverEmail);
                  ...
                  final UpadateData ={
                    ...
                    "CashReceiverNIDBackImageUrl":CashReceiverNIDBackImageUrl
...
@override
  ...
  print("_____________________________________${widget.CashReceiverEmail}");
    super.initState();
  }
