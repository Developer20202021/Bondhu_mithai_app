    ...
    return  Scaffold(
      ...
      appBar: AppBar(
       ...
       automaticallyImplyLeading: false,
        title: const Text("Manager Registration", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
      ...
      body: SingleChildScrollView(
            ...
            SizedBox(
                  ...
                  // if (response.statusCode == 200) {
                    ...
                    // then parse the JSON.
                     final docUser =  FirebaseFirestore.instance.collection("Manager");

                      final jsonData ={

                        "ManagerName":myAdminNameController.text.trim().toLowerCase(),
                        "ManagerEmail":myEmailController.text.trim().toLowerCase(),
                        "emailVerified":"",
                        "AdminApprove":"false",
                  ...
                  ScaffoldMessenger.of(context)
                   ...
                   Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ManagerImageUpload(ManagerEmail: myEmailController.text.trim().toLowerCase(),)),
                );
