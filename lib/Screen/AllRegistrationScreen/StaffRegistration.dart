    ...
    return  Scaffold(
      ...
      appBar: AppBar(
       ...
       automaticallyImplyLeading: false,
        title: const Text("Staff Registration", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
      ...
      body: SingleChildScrollView(
            ...
            SizedBox(
                  ...
                  // if (response.statusCode == 200) {
                    ...
                    // then parse the JSON.
                     final docUser =  FirebaseFirestore.instance.collection("Staff");

                      final jsonData ={

                        "StaffName":myAdminNameController.text.trim().toLowerCase(),
                        "StaffEmail":myEmailController.text.trim().toLowerCase(),
                        "emailVerified":"",
                        "AdminApprove":"false",
                  ...
                  ScaffoldMessenger.of(context)
                   ...
                   Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => StaffImageUpload(StaffEmail: myEmailController.text.trim().toLowerCase(),)),
                );
