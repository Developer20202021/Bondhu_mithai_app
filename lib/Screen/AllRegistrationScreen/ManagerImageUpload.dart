...
class ManagerImageUpload extends StatefulWidget {
  ...
  const ManagerImageUpload({super.key,  required this.ManagerEmail,});

  @override
  State<ManagerImageUpload> createState() => _ManagerImageUploadState();
}

class _ManagerImageUploadState extends State<ManagerImageUpload> {
...
Future NIDBackImageCamera(BuildContext context) async {
  ...
  Future updateData(String ManagerImageUrl,BuildContext context) async{
    ...
    setState(() {
      ...
      print("__________________________________________________________${widget.ManagerEmail}");


         final docUser = FirebaseFirestore.instance.collection("Manager").doc(widget.ManagerEmail);
    ...
    Future updateNIDFrontImageData(String ManagerNIDFrontImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Manager").doc(widget.ManagerEmail);
                  ...
                  final UpadateData ={
                    ...
                    "ManagerNIDFrontImageUrl":ManagerNIDFrontImageUrl
    ...
    Future updateNIDBackImageData(String ManagerNIDBackImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Manager").doc(widget.ManagerEmail);
                  ...
                  final UpadateData ={
                    ...
                    "ManagerNIDBackImageUrl":ManagerNIDBackImageUrl
...
@override
  ...
  print("_____________________________________${widget.ManagerEmail}");
    super.initState();
  }
