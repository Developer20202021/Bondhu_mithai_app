...
class DeliveryManImageUpload extends StatefulWidget {
  ...
  const DeliveryManImageUpload({super.key,  required this.DeliveryManEmail});

  @override
  State<DeliveryManImageUpload> createState() => _DeliveryManImageUploadState();
}

class _DeliveryManImageUploadState extends State<DeliveryManImageUpload> {
...
Future NIDBackImageCamera(BuildContext context) async {
  ...
  Future updateData(String DeliveryManImageUrl,BuildContext context) async{
    ...
    setState(() {
      ...
      print("__________________________________________________________${widget.DeliveryManEmail}");


         final docUser = FirebaseFirestore.instance.collection("DeliveryMan").doc(widget.DeliveryManEmail);

                  final UpadateData ={

                    "DeloiveryManImageUrl":DeliveryManImageUrl
    ...
    Future updateNIDFrontImageData(String DeloiveryManNIDFrontImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("DeliveryMan").doc(widget.DeliveryManEmail);
                  ...
                  final UpadateData ={
                    ...
                    "DeloiveryManNIDFrontImageUrl":DeloiveryManNIDFrontImageUrl
    ...
    Future updateNIDBackImageData(String DeloiveryManNIDBackImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("DeliveryMan").doc(widget.DeliveryManEmail);
                  ...
                  final UpadateData ={
                    ...
                    "DeloiveryManNIDBackImageUrl":DeloiveryManNIDBackImageUrl
...
@override
  ...
  print("_____________________________________${widget.DeliveryManEmail}");
    super.initState();
  }
