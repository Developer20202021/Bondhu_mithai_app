...
class StaffImageUpload extends StatefulWidget {
  ...
  const StaffImageUpload({super.key,  required this.StaffEmail,});

  @override
  State<StaffImageUpload> createState() => _StaffImageUploadState();
}

class _StaffImageUploadState extends State<StaffImageUpload> {
...
Future NIDBackImageCamera(BuildContext context) async {
  ...
  Future updateData(String StaffImageUrl,BuildContext context) async{
    ...
    setState(() {
      ...
      print("__________________________________________________________${widget.StaffEmail}");


         final docUser = FirebaseFirestore.instance.collection("Staff").doc(widget.StaffEmail);
    ...
    Future updateNIDFrontImageData(String StaffNIDFrontImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Staff").doc(widget.StaffEmail);
                  ...
                  final UpadateData ={
                    ...
                    "StaffNIDFrontImageUrl":StaffNIDFrontImageUrl
    ...
    Future updateNIDBackImageData(String StaffNIDBackImageUrl,BuildContext context)
        ...
        loading = true;
         ...
         final docUser = FirebaseFirestore.instance.collection("Staff").doc(widget.StaffEmail);
                  ...
                  final UpadateData ={
                    ...
                    "StaffNIDBackImageUrl":StaffNIDBackImageUrl
...
@override
  ...
  print("_____________________________________${widget.StaffEmail}");
    super.initState();
  }
