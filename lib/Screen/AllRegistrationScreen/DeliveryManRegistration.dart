...
class DeliveryManRegistration extends StatefulWidget {
  ...
  @override
  State<DeliveryManRegistration> createState() => _DeliveryManRegistrationState();
}
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
       ...
       automaticallyImplyLeading: false,
        title: const Text("Delivery Man Registration", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
      ...
      body: SingleChildScrollView(
            ...
            SizedBox(
                  ...
                  // if (response.statusCode == 200) {
                    ...
                    // then parse the JSON.
                     final docUser =  FirebaseFirestore.instance.collection("DeliveryMan");

                      final jsonData ={

                        "DeliveryManName":myAdminNameController.text.trim().toLowerCase(),
                        "DeliveryManEmail":myEmailController.text.trim().toLowerCase(),
                        "emailVerified":"",
                        "AdminApprove":"false",
                        "registrationType":"deliveryman",
                  ...
                  ScaffoldMessenger.of(context)
                   ...
                   Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DeliveryManImageUpload(DeliveryManEmail: myEmailController.text.trim().toLowerCase())),
                );
