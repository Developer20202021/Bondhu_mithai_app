...
class DeliveryFeeAdd extends StatefulWidget {
  const DeliveryFeeAdd({super.key});

  @override
  State<DeliveryFeeAdd> createState() => _DeliveryFeeAddState();
}

class _DeliveryFeeAddState extends State<DeliveryFeeAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Change Delivery Fee",  style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
          ...
          painter: CurvePainter(),
              ...
              color: myFocusNode.hasFocus ? Color.fromRGBO(92, 107, 192, 1): Colors.black
                  ...
                  //           )));
                        ...
                        }, child: Text("Change", style: TextStyle(color: Colors.white),), style: ButtonStyle(
