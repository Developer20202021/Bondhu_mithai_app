...
class SendSMSToAllCustomer extends StatefulWidget {


  const SendSMSToAllCustomer({super.key,});

  @override
  State<SendSMSToAllCustomer> createState() => _SendSMSToAllCustomerState();
}

class _SendSMSToAllCustomerState extends State<SendSMSToAllCustomer> {
...
try {
               ...
               final response = await http
                                .get(Uri.parse('https://api.greenweb.com.bd/api.php?token=100651104321696050272e74e099c1bc81798bc3aa4ed57a8d030&to=${AllData[i]["CustomerPhoneNumber"].toString().trim()}&message=${CustomerMSg}'));
        ...
        print("_Success_____________________________________________________${i}");
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("SMS Send ${SendSMSCount}/${TotalCustomer}")));
...
@override
  ...
  CustomerMSgController.text = "Dear Customer,  ধন্যবাদ";
    ...
    return Scaffold(
      ...
      body: loading?Center(
        ...
        AwesomeDialog(
            ...
            animType: AnimType.rightSlide,
            title: 'Are You Sure?',
            desc: 'You Want to send SMS to All Customer. If you want, press the Ok Button. For Cancel press Cancel Button',
