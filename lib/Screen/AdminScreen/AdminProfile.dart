...
//     Query CustomerOrderHistoryQuery = _collectionCustomerOrderHistoryRef.where("AdminEmail", isEqualTo: widget.AdminEmail);
  ...
  Widget build(BuildContext context) {
    ...
    //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductScreen(indexNumber: "2",)));
      ...
      appBar: AppBar(
        ...
        title: const Text("Admin Profile", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
               ...
               SizedBox(
                  ...
                  BorderSide(color: Colors.white, width: 10.0)),
                      textBaseline: TextBaseline.ideographic,
                        ...
                        TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["AdminEmail"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                         ...
                         TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["AdminAddress"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                          ...
                          TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["AdminPhoneNumber"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["AdminNIDFrontImageUrl"]}", fit: BoxFit.cover),
                  ),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["AdminNIDBackImageUrl"]}", fit: BoxFit.cover),
                  ),
      ...
      //                             Text("Phone Number:${AllOrderHistoryData[i]["AdminEmail"]}"),
      ...
      //                             //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => EveryCustomerAllDueOrder(indexNumber: "", AdminEmail: AllData[0]["AdminEmail"])));
