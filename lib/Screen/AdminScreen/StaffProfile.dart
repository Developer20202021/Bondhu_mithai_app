...
class StaffProfile extends StatefulWidget {
  ...
  const StaffProfile({super.key, required this.StaffEmail});

  @override
  State<StaffProfile> createState() => _EditCustomerInfoState();
}

class _EditCustomerInfoState extends State<StaffProfile> {
...
Future<void> getData(String StaffEmail) async {
    // Get docs from collection reference
    // QuerySnapshot querySnapshot = await _collectionRef.get();


    Query query = _collectionRef.where("StaffEmail", isEqualTo: StaffEmail);
...
//     Query CustomerOrderHistoryQuery = _collectionCustomerOrderHistoryRef.where("StaffEmail", isEqualTo: widget.StaffEmail);
  ...
  Widget build(BuildContext context) {
    ...
    //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductScreen(indexNumber: "2",)));
      ...
      appBar: AppBar(
        ...
        title: const Text("Staff Profile", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
               ...
               SizedBox(
                  ...
                  BorderSide(color: Colors.white, width: 10.0)),
                      textBaseline: TextBaseline.ideographic,
                        ...
                        TableRow(
                          ...
                          children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text("${AllData[0]["StaffName"].toString().toUpperCase()}", style: TextStyle(fontSize: 15.0),),
                                    )),
                        ...
                        TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["StaffEmail"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                         ...
                         TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["StaffAddress"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                          ...
                          TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["StaffPhoneNumber"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["StaffNIDFrontImageUrl"]}", fit: BoxFit.cover),
                  ),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["StaffNIDBackImageUrl"]}", fit: BoxFit.cover),
                  ),
      ...
      //                             Text("Phone Number:${AllOrderHistoryData[i]["StaffEmail"]}"),
      ...
      //                             //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => EveryCustomerAllDueOrder(indexNumber: "", StaffEmail: AllData[0]["StaffEmail"])));
