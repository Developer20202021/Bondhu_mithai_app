...
class ManagerProfile extends StatefulWidget {
  ...
  const ManagerProfile({super.key, required this.ManagerEmail});

  @override
  State<ManagerProfile> createState() => _EditCustomerInfoState();
}

class _EditCustomerInfoState extends State<ManagerProfile> {
...
Future<void> getData(String ManagerEmail) async {
    // Get docs from collection reference
    // QuerySnapshot querySnapshot = await _collectionRef.get();


    Query query = _collectionRef.where("ManagerEmail", isEqualTo: ManagerEmail);
...
//     Query CustomerOrderHistoryQuery = _collectionCustomerOrderHistoryRef.where("ManagerEmail", isEqualTo: widget.ManagerEmail);
  ...
  Widget build(BuildContext context) {
    ...
    //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductScreen(indexNumber: "2",)));
      ...
      appBar: AppBar(
        ...
        title: const Text("Manager Profile", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
               ...
               SizedBox(
                  ...
                  BorderSide(color: Colors.white, width: 10.0)),
                      textBaseline: TextBaseline.ideographic,
                        ...
                        TableRow(
                          ...
                          children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text("${AllData[0]["ManagerName"].toString().toUpperCase()}", style: TextStyle(fontSize: 15.0),),
                                    )),
                        ...
                        TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["ManagerEmail"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                         ...
                         TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["ManagerAddress"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                          ...
                          TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["ManagerPhoneNumber"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["ManagerNIDFrontImageUrl"]}", fit: BoxFit.cover),
                  ),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["ManagerNIDBackImageUrl"]}", fit: BoxFit.cover),
                  ),
      ...
      //                             Text("Phone Number:${AllOrderHistoryData[i]["ManagerEmail"]}"),
      ...
      //                             //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => EveryCustomerAllDueOrder(indexNumber: "", ManagerEmail: AllData[0]["ManagerEmail"])));
