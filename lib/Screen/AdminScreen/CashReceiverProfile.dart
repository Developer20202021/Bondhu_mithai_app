...
class CashReceiverProfile extends StatefulWidget {


  final String CashReceiverEmail;
  ...
  const CashReceiverProfile({super.key, required this.CashReceiverEmail});

  @override
  State<CashReceiverProfile> createState() => _EditCustomerInfoState();
}

class _EditCustomerInfoState extends State<CashReceiverProfile> {
...
Future<void> getData(String CashReceiverEmail) async {
    // Get docs from collection reference
    // QuerySnapshot querySnapshot = await _collectionRef.get();


    Query query = _collectionRef.where("CashReceiverEmail", isEqualTo: CashReceiverEmail);
...
//     Query CustomerOrderHistoryQuery = _collectionCustomerOrderHistoryRef.where("CashReceiverEmail", isEqualTo: widget.CashReceiverEmail);
...
@override
  void initState() {
    ...
    getData(widget.CashReceiverEmail);
  ...
  Widget build(BuildContext context) {
    ...
    //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductScreen(indexNumber: "2",)));
      ...
      appBar: AppBar(
        ...
        title: const Text("CashReceiver Profile", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16),),
                      ...
                      Center(
                        child:  CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                            "${AllData[0]["CashReceiverImageUrl"]}",
                          ),
                        ),
                      ),
               ...
               SizedBox(
                  ...
                  BorderSide(color: Colors.white, width: 10.0)),
                      textBaseline: TextBaseline.ideographic,
                        ...
                        TableRow(
                          ...
                          children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text("${AllData[0]["CashReceiverName"].toString().toUpperCase()}", style: TextStyle(fontSize: 15.0),),
                                    )),
                        ...
                        TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["CashReceiverEmail"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                         ...
                         TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["CashReceiverAddress"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                          ...
                          TableRow(decoration: BoxDecoration(color: Colors.grey[200]),children: [
                                  ...
                                  Container(child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("${AllData[0]["CashReceiverPhoneNumber"]}", style: TextStyle(fontSize: 15.0),),
                                  )),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["CashReceiverNIDFrontImageUrl"]}", fit: BoxFit.cover),
                  ),
                ...
                height: 300,
                  ...
                  borderRadius: BorderRadius.circular(10)      
                    ...
                    child: Image.network("${AllData[0]["CashReceiverNIDBackImageUrl"]}", fit: BoxFit.cover),
                  ),
      ...
      //                             Text("Phone Number:${AllOrderHistoryData[i]["CashReceiverEmail"]}"),
      ...
      //                             //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => EveryCustomerAllDueOrder(indexNumber: "", CashReceiverEmail: AllData[0]["CashReceiverEmail"])));
