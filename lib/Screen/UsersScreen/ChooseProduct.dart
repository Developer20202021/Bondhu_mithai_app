...
import 'package:bondhu_mithai_app/Screen/UsersScreen/Cart.dart';
...
class ChooseUserFoods extends StatefulWidget {
  ...
  const ChooseUserFoods({super.key,  required this.CustomerName, required this.CustomerPhoneNumber});

  @override
  State<ChooseUserFoods> createState() => _ChooseUserFoodsState();
}

class _ChooseUserFoodsState extends State<ChooseUserFoods> {
...
// hive database
  ...
  void writeData( List WriteData){
    ...
    print(_mybox.get("UserAddToCartFood"));
     ...
     Navigator.of(context).push(MaterialPageRoute(builder: (context) => CustomerCartScreen( CustomerName: widget.CustomerName, CustomerPhoneNumber: widget.CustomerPhoneNumber,)));
