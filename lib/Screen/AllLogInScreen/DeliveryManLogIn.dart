  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Delivery Man Log In",  style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (AllData[0]["AdminApprove"] == "true") {
                             ...
                             Navigator.push(context, MaterialPageRoute(builder: (context) => DeliveryManCustomers(indexNumber: "1")),);
